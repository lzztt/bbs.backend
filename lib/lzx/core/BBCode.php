...
class BBCode
{
    ...
    {
        static $bbc = [
            'code' => ['code' => ['type' => BBCODE_TYPE_NOARG, 'open_tag' => '<code class="code">', 'close_tag' => '</code>', 'content_handling' => [__CLASS__, 'escape']]],
            'tags' => [
                ...
                'img' => ['type' => BBCODE_TYPE_OPTARG, 'open_tag' => '', 'close_tag' => '', 'default_arg' => '{CONTENT}', 'content_handling' => [__CLASS__, 'img']],
                ...
                'list' => ['type' => BBCODE_TYPE_OPTARG, 'open_tag' => '', 'close_tag' => '', 'default_arg' => '', 'content_handling' => [__CLASS__, 'listHandler']],
                'youtube' => ['type' => BBCODE_TYPE_NOARG, 'open_tag' => '', 'close_tag' => '', 'content_handling' => [__CLASS__, 'youtube']],
                'googlemap' => ['type' => BBCODE_TYPE_NOARG, 'open_tag' => '', 'close_tag' => '', 'content_handling' => [__CLASS__, 'googlemap']],
            ]
        ];
    ...
    private static function escape($content, $param)
    {
        return str_replace(['[', ']'], ['&#91;', '&#93;'], $content);
    }

    private static function img($content, $param)
    {
        return '<img class="bb_image" src="' . $content . '" alt="' . ($param == '{CONTENT}' ? $content : $param) . '">';
    }

    private static function listHandler($content, $param)
    {
        $li = '';
