...
abstract class Node extends Controller
{
   ...
   public function _tagForumTopic( $nid )
   {
   ...
   public function _displayForumTopic( $nid )
   {
      $nodeObj = new NodeObject();
   ...
   public function authorPanel( $info )
   {
      static $authorPanels = [ ];
   ...
   public function attachments( $files, $body )
   {
      $attachments = NULL;
      $_files = [ ];
      $_images = [ ];
   ...
   public function _editForumTopic( $nid )
...
// refresh node content cache
   ...
   public function _deleteForumTopic( $nid )
   {
      $this->cache->setStatus( FALSE );
   ...
   public function _commentForumTopic( $nid )
   { // create new comment
      $this->cache->setStatus( FALSE );
   ...
   public function _displayYellowPage( $nid )
   {
      $nodeObj = new NodeObject();
   ...
   public function _editYellowPage( $nid )
   {
      $this->cache->setStatus( FALSE );
...
// refresh node content cache
   ...
   public function _deleteYellowPage( $nid )
   {
      $this->cache->setStatus( FALSE );
      if ( $this->request->uid != 1 )
      {
   ...
   public function _commentYellowPage( $nid )
   { // create new comment
      $this->cache->setStatus( FALSE );
   ...
   public function _activityForumTopic( $nid )
   {
