        ...
        <div class="content">
          ...
          <ul style="padding-left: 1.5em;">
            <?php foreach ($yp[$tid]['children'] as $groupID): ?>
              <li class="l1">
                <a title="<?php echo $yp[$groupID]['description']; ?>" href="/yp/<?php echo $yp[$groupID]['id']; ?>"><?php echo $yp[$groupID]['name']; ?></a>
                <ul>
                  <?php foreach ($yp[$groupID]['children'] as $tagID): ?>
                    <li class="l2"><a title="<?php echo $yp[$tagID]['description']; ?>" href="/yp/<?php echo $yp[$tagID]['id']; ?>"><?php echo $yp[$tagID]['name']; ?></a></li>
                    <?php endforeach; ?>
                </ul>
              </li>
            <?php endforeach; ?>
