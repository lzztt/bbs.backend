...
<form accept-charset="UTF-8" autocomplete="off" method="post" action="<?php print $action; ?>" enctype="multipart/form-data">
  ...
  <div class="form_element">
    <label>微信</label>
    <input size="22" name="wechat" type="text" value="<?php print $wechat; ?>">
  </div>
  <div class="form_element">
    <label>QQ</label>
  ...
  <div class="form_element">
    ...
    名 <input size="10" name="firstname" type="text" value="<?php print $firstname; ?>">
    姓 <input size="10" name="lastname" type="text" value="<?php print $lastname; ?>">
  </div>
  <div class="form_element">
    <label>性别</label>
...
<div class="form_element">
  ...
  月(mm) <input size="10" name="bmonth" type="text" value="<?php print $bmonth; ?>">
  日(dd) <input size="10" name="bday" type="text" value="<?php print $bday; ?>">
  年(yyyy) <input size="10" name="byear" type="text" value="<?php print $byear; ?>">
</div>
<div class="form_element">
  <label>职业</label><input size="22" name="occupation" type="text" value="<?php print $occupation; ?>">
</div>
<div class="form_element">
  <label>兴趣爱好</label><input size="22" name="interests" type="text" value="<?php print $interests; ?>">
</div>
<div class="form_element">
  <label>自我介绍</label><textarea rows="5" cols="50" name="aboutme"><?php print $aboutme; ?></textarea>
</div>
