...
?>
  ...
  <div style="text-align: center;">
    ...
    <?php endif ?>
    <div class="pm_icon">
      <svg class="svg_icon" focusable="false" viewBox="0 0 24 24" aria-hidden="true" style="color:#3f51b5; cursor:pointer;" onclick='window.app.openMsgEditor({toUser: {id:<?= $uid ?>,username:"<?= $username ?>"}})'>
