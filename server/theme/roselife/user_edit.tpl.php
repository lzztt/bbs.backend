...
<form accept-charset="UTF-8" autocomplete="off" method="post" enctype="multipart/form-data">
  <fieldset>
    ...
    <input name="avatar" type="file"><img class="avatar" src="<?= $avatar ?>">
  </fieldset>
  <fieldset>
  ...
  <fieldset>
    ...
    <input name="website" type="url" value="<?= $website ?>">
  </fieldset>
  <fieldset>
    <label class='label' data-help="不会公开显示">姓名</label>
    名 <input class='name' name="firstname"  type="text" value="<?= $firstname ?>">
    姓 <input class='name' name="lastname" type="text" value="<?= $lastname ?>">
  </fieldset>
  <fieldset>
  ...
  <fieldset>
    ...
    <input name="birthday" type="date" value="<?= $birthday ?>">
  </fieldset>
  <fieldset>
    <label class='label'>职业</label><input name="occupation" type="text" value="<?= $occupation ?>">
  </fieldset>
  <fieldset>
    <label class='label'>兴趣爱好</label><input name="interests" type="text" value="<?= $interests ?>">
  </fieldset>
  <fieldset>
    <label class='label'>自我介绍</label><textarea name="aboutme"><?= $aboutme ?></textarea>
  </fieldset>
