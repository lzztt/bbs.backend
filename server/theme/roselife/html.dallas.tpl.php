...
<html lang='zh' dir='ltr'>
   <head>
      ...
      <?php if ( $tpl_debug ): ?>
         ...
         <script src="/themes/<?php print $tpl_theme; ?>/js/main.dallas.js"></script>
      <?php else: ?>
         <script src="/themes/<?php print $tpl_theme; ?>/js/min_1408898412.js"></script>
         <script src="/themes/<?php print $tpl_theme; ?>/js/min_1408898412.dallas.js"></script>
      <?php endif; ?>
      <!--END JS-->
      ...
      <?php else: ?>
         ...
         <link href="/themes/<?php print $tpl_theme; ?>/css/min_1408898412.dallas.css" rel="stylesheet" type="text/css">
      <?php endif; ?>
      <!--END CSS-->
