...
<html lang='zh' dir='ltr'>
   <head>
      ...
      <?php else: ?>
         <script src="/themes/<?php print $tpl_theme; ?>/js/min_1408816541.js"></script>
      <?php endif; ?>
      <!--END JS-->
      ...
      <?php else: ?>
         <link href="/themes/<?php print $tpl_theme; ?>/css/min_1408816541.css" rel="stylesheet" type="text/css">
      <?php endif; ?>
      <!--END CSS-->
