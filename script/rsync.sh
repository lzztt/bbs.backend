...
rsync -ave 'ssh -p 3355' server web@houstonbbs.com:bbs/ --exclude='Config.php' --exclude='alexa.houston.tpl.php' --exclude='alexa.dallas.tpl.php' --exclude='alexa.austin.tpl.php' 
