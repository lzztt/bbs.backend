<div id="content">
  ...
  <div id="forum">
        ...
        <?php foreach ($forum['children'] as $group): ?>
          ...
          <?php foreach ($group['children'] as $board): ?>
            <tr id="forum-list-4" class="middle-row in-container-0">
              ...
              <td class="forum-icon"> <img src="/themes/default/images/pc/forum/forum-folder.png" alt="文件夹" title="文件夹" width="33" height="29" /> </td>
    ...
    <div class="forum-folder-legend forum-smalltext clear-block">
      <dl>
        <dt><img src="/themes/default/images/pc/forum/forum-folder-new-posts.png" alt="有新贴" title="有新贴" width="33" height="29" /></dt>
        <dd>有新贴</dd>

        <dt><img src="/themes/default/images/pc/forum/forum-folder.png" alt="有新回复" title="有新回复" width="33" height="29" /></dt>
        <dd>有新回复</dd>
        <dt><img src="/themes/default/images/pc/forum/forum-folder-locked.png" alt="论坛被锁定" title="论坛被锁定" width="33" height="29" /></dt>
        <dd>论坛被锁定</dd>
      </dl>
    </div>
