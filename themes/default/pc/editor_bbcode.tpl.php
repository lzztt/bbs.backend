<div id="editor-div" style="display:<?php echo ($display ? 'block' : 'none'); ?>;">
  <form enctype="multipart/form-data" id="editor-form" method="post" accept-charset="UTF-8" action="<?php echo $form_handler; ?>">
    <div id="edit-title" class="form-item" style="display:<?php echo ($title_display ? 'block' : 'none'); ?>;">
      <label for="title">标题:<span title="此项必填。" class="form-required">*</span></label>
      <input type="text" class="form-text required" value="<?php echo $node_title; ?>" size="60" id="title" name="title" maxlength="50" placeholder="最少5个字母或3个汉字" />
    </div>
