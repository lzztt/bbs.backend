      ...
      <div id="forum">
         ...
         <div class="forum-top-links">
            <ul class="links forum-links">
               ...
               <?php else: ?>
                  <li>您需要先<a href="/user">登录</a>或<a href="/user/register">注册</a>才能发表新话题</li>
               <?php endif; ?>
            </ul>
         </div>
               ...
               <?php foreach ($nodes as $node): ?>
                  <tr class="<?php echo ($node['weight'] >= 1) ? ' sticky-topic' : ''; ?>">
                     <td class="icon"><div class="forum-icon">
                           ...
                           <img src="/themes/default/images/pc/forum/topic-<?php echo ($node['weight'] >= 1) ? 'sticky' : 'default' ?>.png" alt="" title="" width="22" height="22" />
                        </div></td>
         ...
         <div class="forum-topic-legend forum-smalltext clear-block">
            <div class="legend-group">
               <dl>
                  <dt><img src="/themes/default/images/pc/forum/topic-default.png" alt="没有新贴" title="没有新贴" width="22" height="22" /></dt>
                  <dd>没有新贴</dd>
               </dl>

               <dl>
                  <dt><img src="/themes/default/images/pc/forum/topic-new.png" alt="新贴" title="新贴" width="22" height="22" /></dt>
                  <dd>新贴</dd>
               </dl>
            </div>
            ...
            <div class="legend-group">
               <dl>
                  <dt><img src="/themes/default/images/pc/forum/topic-hot.png" alt="过去热贴" title="过去热贴" width="22" height="22" /></dt>

                  <dd>过去热贴</dd>
               </dl>
               <dl>
                  <dt><img src="/themes/default/images/pc/forum/topic-hot-new.png" alt="最新热贴" title="最新热贴" width="22" height="22" /></dt>
                  <dd>最新热贴</dd>
               </dl>
            </div>
            ...
            <div class="legend-group">
               <dl>
                  <dt><img src="/themes/default/images/pc/forum/topic-sticky.png" alt="置顶热点" title="置顶热点" width="22" height="22" /></dt>
                  <dd>置顶热点</dd>
               </dl>
               <dl>
                  <dt><img src="/themes/default/images/pc/forum/topic-closed.png" alt="锁定的讨论" title="锁定的讨论" width="22" height="22" /></dt>
                  <dd>锁定的讨论</dd>
               </dl>
            </div>
         </div>
