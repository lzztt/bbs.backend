      ...
      <div class="forum-topic-header clear-block">
         ...
         <div class="forum-top-links">
            <ul class="links forum-links">
               ...
               <li data-urole='<?php echo $urole_user; ?>'><a class="bb-reply button" href="/node/<?php echo $nid; ?>/comment">回复</a></li>
               <li data-urole='<?php echo $urole_guest; ?>'>您需要先<a href="/user">登录</a>或<a href="/user/register">注册</a>才能发表话题或回复</li>
            </ul>
         </div>
      ...
      <?php foreach ($posts as $index => $p): ?>
         ...
         <div class="forum-post-wrapper clear-block">
            ...
            <div class="forum-post-main">
               <div class="post-info">
                  <span data-umode='<?php echo $umode_mobile; ?>'><a href="/user/<?php echo $p['uid']; ?>" title="浏览用户信息"><?php echo $p['username'];?></a> @ <?php echo $p['city']; ?> @</span> 
                  ...
                  <div class="post-links" data-urole='<?php echo $urole_user; ?>'>
                     <ul class="links inline forum-links">
                        <?php if ($tid == 16 && $p['type'] == 'node'): ?>
                           <li><a title="发布为活动" class="activity-link button" data-urole="<?php echo $urole_adm . $tid . ' ' . $urole_user . $p['uid']; ?>" id="<?php echo $p['type'] . '-' . $p['id']; ?>-activity" href="<?php echo '/' . $p['type'] . '/' . $p['id'] . '/activity'; ?>">发布为活动</a></li>
                        <?php endif; ?>
                        <li><a title="Edit" class="bb-edit button" data-urole="<?php echo $urole_adm . $tid . ' ' . $urole_user . $p['uid']; ?>" id="<?php echo $p['type'] . '-' . $p['id']; ?>-edit" href="<?php echo '/' . $p['type'] . '/' . $p['id'] . '/edit'; ?>">编辑</a></li>
                        <li><a title="Delete" class="delete button" data-urole="<?php echo $urole_adm . $tid . ' ' . $urole_user . $p['uid']; ?>" id="<?php echo $p['type'] . '-' . $p['id']; ?>-delete" href="<?php echo '/' . $p['type'] . '/' . $p['id'] . '/delete'; ?>">删除</a></li>
