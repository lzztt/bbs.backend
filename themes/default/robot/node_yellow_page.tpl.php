<div id="content">
   <div id="content-area">
      <div class="node-type-yp" id="node-2622">
         <div class="node-inner">
            ...
            <div class="forum-top-links">
               <ul class="links forum-links">
                  <?php if ($isLoggedIn): ?>
                     <li><a class="reply button" href="/node/<?php echo $nid; ?>/comment">评论</a></li>
                  <?php else: ?>
                     <li>您需要先<a href="/user">登录</a>或<a href="/user/register">注册</a>才能发表评论</li>
                  <?php endif; ?>
               </ul>
            </div>

            <div class="reply-count">
               <?php echo $commentCount; ?> replies, <?php echo $viewCount; ?> views,
               <?php if (isset($pager)): ?>
                  <div class="item-list">
            ...
            <table>
               <tbody>
                  ...
                  <?php if (isset($node['email'])): ?>
                     <tr><td>地址:</td><td><?php echo $node['email']; ?></td></tr>
                  <?php endif; ?>
         ...
         <div><?php echo $node['HTMLbody']; ?></div>
                  ...
                  <?php if ($isLoggedIn): ?>
                     <div class="post-links">
                        <ul class="links inline forum-links">
                           <li><a title="Edit" class="edit <?php echo 'u' . $c['uid']; ?> hidden button" id="<?php echo $c['type'] . '-' . $c['id']; ?>-edit" href="<?php echo '/' . $c['type'] . '/' . $c['id'] . '/edit'; ?>">编辑</a></li>
                           <li><a title="Delete" class="delete <?php echo 'u' . $c['uid']; ?> hidden button" id="<?php echo $c['type'] . '-' . $c['id']; ?>-delete" href="<?php echo '/' . $c['type'] . '/' . $c['id'] . '/delete'; ?>">删除</a></li>
                        </ul>
                     </div>
